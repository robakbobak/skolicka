...
--
-- Hostiteľ: 127.0.0.1
-- Čas generovania: St 14.Okt 2020, 08:49
...
CREATE TABLE `c_trieda` (
  ...
  `nazov_trieda` varchar(50) NOT NULL,
...
(1, 'robo', 'toth', '2020-04-14', 0, 'robototh', 'b6dfc495f89dea91ea51408140fdf0740f3a6bff'),
(2, 'Michal', 'Jegh', '6666-06-09', 0, 'miskojegh', 'b6dfc495f89dea91ea51408140fdf0740f3a6bff'),
(3, 'Marina', 'Jorick', '2020-10-16', 0, 'marinajorick', 'b6dfc495f89dea91ea51408140fdf0740f3a6bff');
...
--
ALTER TABLE `c_trieda`
  MODIFY `idc_trieda` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `uzivatelia`
  MODIFY `iduzivatelia` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
